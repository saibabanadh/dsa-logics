          ...
          if(value < currentNode.value){
              ...
              if(currentNode.right === null){ // Option1: No right chhild
                  if(parentNode === null){
                      ...
                      if(parentNode.value > currentNode.value){ // if parent > current value
                          parentNode.left = currentNode.left;
                      }else if(parentNode.value < currentNode.value){ // if parent < current value
                          parentNode.right = currentNode.left;
                      }
                  }
              }else if(currentNode.right.left === null){ //Option2: Right child which doesn't have left child
                  if(parentNode === null){
                      this.root = currentNode.left;
                  }else{
              ...
              }else{ //Option3: Right child that a left child
